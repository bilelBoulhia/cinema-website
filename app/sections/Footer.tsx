...
export default function Footer() {
    return (
        ...
        <footer className="border-gray-800 border-t-[1px]">
            <div className="mx-auto w-full px-2 p-1 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            <h2 className="mb-6 text-xs font-semibold text-gray-900 uppercase dark:text-white">Follow
                                us</h2>
                            <ul className="text-gray-500 text-xs dark:text-gray-400 font-medium">
                                <li className="mb-4">
                                ...
                                <li>
                                    <a href="https://discord" className="hover:underline">Discord</a>
                                </li>
                            </ul>
                        </div>
...
function GithubIcon(props: any) {
    return (
        <Image src={ts} alt='icon' width='20' height='20' {...props} />
    )
}
...
function TwitterIcon(props: any) {
    return (
        <Image src={instagram} alt='icon' width='20' height='20' {...props} />
    )
}
...
function YoutubeIcon(props: any) {
    return (
        <Image src={git} alt='icon' width='20' height='20' {...props} />
    )
}